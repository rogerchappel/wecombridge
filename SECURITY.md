...
`wecombridge` has not published a stable release yet. Security fixes target the default branch until versioned releases exist.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `wecombridge` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in wecombridge.
